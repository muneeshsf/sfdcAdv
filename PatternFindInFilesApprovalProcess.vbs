Option Explicit 
   ...
   '* 
    ...
    Dim strInput1, strInput2, cFOL, StrDirectory,strInput3
	strInput1="BMG Sales"
  ...
  ' strInput = Inputbox("Enter the text1 you would like to search for.")
   ...
   MyString = "FileSearchResult_ApprovalProcess"
   strWritePath = "C:\Muneesh\ApprovalProcess\" & MyString & ".txt"
   strDirectory =  "C:\Muneesh\ApprovalProcess\"
...
Set objOutputFile = objFileSystem.OpenTextFile("C:\Muneesh\ApprovalProcess\" & MyString & ".txt", ForWriting)
