Option Explicit 
  ...
  ' strInput = Inputbox("Enter the text1 you would like to search for.")
   ...
   MyString = "FileSearchResultEmail"
   strWritePath = "C:\Muneesh\EmailTempLates\" & MyString & ".txt"
   strDirectory =  "C:\Muneesh\EmailTempLates\"
...
Set objOutputFile = objFileSystem.OpenTextFile("C:\Muneesh\CustomMetaData\" & MyString & ".txt", ForWriting)
