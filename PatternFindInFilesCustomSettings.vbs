Option Explicit 
  ...
  ' strInput = Inputbox("Enter the text1 you would like to search for.")
   ...
   MyString = "FileSearchResultCSettings"
   strWritePath = "C:\Muneesh\CustomSettingsExport\" & MyString & ".txt"
   strDirectory =  "C:\Muneesh\CustomSettingsExport\"
...
Set objOutputFile = objFileSystem.OpenTextFile("C:\Muneesh\CustomSettingsExport\" & MyString & ".txt", ForWriting)
